...
namespace QuicDotNet
{
    ...
    public class MultiplexingManager : ConcurrentQueue<MultiplexedTransfer>
    {
        ...
        public async Task<Packet> CutNextPacketAsync()
        {
            ...
            var regular = Packet.Regular(this._connectionid.Value, packetNumber, null); // TODO: FEC GROUP's.

            remaining -= regular.Length;
