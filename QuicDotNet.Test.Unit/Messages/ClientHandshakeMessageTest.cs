        ...
        internal static readonly Dictionary<uint, byte[]> ClientInchoateGoogleCachedServerParametersClientMessageSubsetParameters = new Dictionary<uint, byte[]>
                       {
                           ...
                           { MessageTags.SNI, Encoding.ASCII.GetBytes("www.google.com") },
                           ...
                           { MessageTags.VER, Encoding.ASCII.GetBytes("Q025") },
                           ...
                           { MessageTags.MSPC, BitConverter.GetBytes((uint)100) },
                           { MessageTags.AEAD, Encoding.ASCII.GetBytes("AESG") },
                           { MessageTags.UAID, Encoding.ASCII.GetBytes("Chrome/49.0.2623.0 Windows NT 6.1; WOW64") },
                           { MessageTags.SCID, new byte[] { 0x9d, 0xbc, 0xc3, 0x51, 0x1f, 0x2d, 0x6c, 0x17, 0xe4, 0x74, 0x85, 0xad, 0x89, 0xf4, 0x5e, 0x8b } },
                           { MessageTags.TCID, BitConverter.GetBytes((uint)0) },
                           { MessageTags.PDMD, Encoding.ASCII.GetBytes("X509") },
                           { MessageTags.SRBF, BitConverter.GetBytes((uint)1048576) },
                           { MessageTags.ICSL, BitConverter.GetBytes((uint)30) },
                           ...
                           { MessageTags.SCLS, BitConverter.GetBytes((uint)1) },
                           { MessageTags.KEXS, Encoding.ASCII.GetBytes("C255") },
                           { MessageTags.COPT, BitConverter.GetBytes((uint)1146636614) },
                           ...
                           { MessageTags.IRTT, BitConverter.GetBytes((uint)24233) },
                           ...
                           { MessageTags.CFCW, BitConverter.GetBytes((uint)15728640) },
                           { MessageTags.SFCW, BitConverter.GetBytes((uint)6291456) }
                       };
